...
class VirtioPinchTests(unittest.TestCase):
    ...
    def test_touchpad_capabilities_and_contact_frames(self):
        ...
        # A single-button indirect pad must declare BUTTONPAD; otherwise
        # libinput logs a kernel bug and guesses this classification itself.
        ...
        self.assertFalse(keys & (1 << 0x111))  # no separate right button on a clickpad
